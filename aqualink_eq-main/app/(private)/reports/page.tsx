...
import StepAccordionItem from "@/components/reports/step-accordion-item";
...
export default function ReportsPage() {
  ...
  const { isGenerating, generateCsv } = useReportGenerator(data);
  ...
  return (
    <div className="container mx-auto space-y-8 min-h-screen p-6 font-sans">
      <PageHeader
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <SummaryCard
            ...
            dateRange={dateRange}
            onGenerate={() => generateCsv(selectedKpis)}
